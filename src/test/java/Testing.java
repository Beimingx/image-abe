...
public class Testing {
    ...
    public void testDCPABE2() {
        ...
        pkeys.addKey(DCPABE.keyGen("user", "a", authority1.getSecretKeys().get("a"), gp));//b is not satisfying
        pkeys.addKey(DCPABE.keyGen("user", "d", authority2.getSecretKeys().get("d"), gp));//c is not satisfying
        ...
        System.out.println("test DCPABE2 success!");
    }
    ...
    public void testDCPABE1() {
        ...
        PersonalKeys pkeys = new PersonalKeys("user");
        PersonalKey k_user_a = DCPABE.keyGen("user", "d", authority0.getSecretKeys().get("d"), gp);
        PersonalKey k_user_d = DCPABE.keyGen("user", "a", authority0.getSecretKeys().get("a"), gp);
        //success:a+d d+a
        //false:a+c a+b b+c b+d d+c a+c
        ...
        assertArrayEquals(message.getM(), dMessage.getM());
        System.out.println("test DCPABE1 success!");
    }
